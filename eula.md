...
## **1\. Age Restriction, Eligibility, and Export Control**
...
## **2\. License Grant, Intellectual Property, and Restrictions**
...
## **3\. Lawful Use, Platform Compliance, and User Responsibility**
...
* **No Covert Surveillance:** The Application is not designed, marketed, or authorized to be used as hidden spyware, stalkerware, or for any form of covert monitoring.  
* **User Content and Copyright Responsibility:** You are solely responsible for any content captured, transmitted, or stored using the Application, and for ensuring that such content does not infringe upon the intellectual property or copyright of third parties. The Developer disclaims all secondary liability for copyright infringement arising from your use of the Application.  
* **Jurisdictional Compliance:** You acknowledge that laws regarding audio and video recording vary significantly by jurisdiction (e.g., "one-party" vs. "two-party" consent laws). You are solely responsible for understanding and strictly complying with the local, provincial, state, and federal laws in your specific location.  
* **Platform Compliance:** You agree to comply with all applicable platform policies, including Google Play Developer Program Policies, when using the Application.  
* **Law Enforcement:** We reserve the right to report activity to law enforcement authorities and to cooperate fully with any lawful subpoenas, court orders, or official investigations where we reasonably believe there has been unlawful use of the Application, or where required by applicable law.
...
* **Firebase Authentication:** Account creation, login, and cross-device synchronization are handled exclusively by Google Firebase. We are not liable for account lockouts, authentication failures, or Firebase system outages.  
* **Account Responsibility:** You are responsible for maintaining the security of your devices and accounts and for all activity occurring under your account. You are solely responsible for the security of your Google credentials.  
* **Google Drive Storage:** If you choose to save media, it is stored on your personal Google Drive. We have no control over Google Drive’s availability, data retention, or access policies. We are not liable if Google suspends or limits your Drive access, nor are we liable for any data loss, corruption, or unauthorized access occurring on Google Drive. Your use of this storage is governed by Google’s Terms of Service.

## **6\. Developer-Operated Infrastructure and Performance Variability**

To facilitate live video routing, the Developer operates a proprietary relay server. You acknowledge that:

* **Relay Only:** This server acts strictly as a data pass-through. It does not retain, record, or store user video or audio data. Connection metadata such as IP addresses may be transiently processed by the relay server solely for routing purposes and are not retained beyond what is technically necessary to operate, secure, and maintain the service.  
* **No Uptime Guarantee:** The server is provided on a "best-effort" basis. We make no representations, warranties, or guarantees regarding server availability or uptime.  
* **Performance Disclaimers:** Live video routing is highly dependent on environmental factors, ISP throttling, and local network quality. The stream may be subject to significant latency, packet loss, degraded resolution, or complete connectivity failures.  
* **Network Availability:** The Application may not function in all regions, networks, or environments.  
* **Limitation of Liability:** We are explicitly not liable for service interruptions, connection drops, stream failures, or server crashes, regardless of the circumstances surrounding the interruption.

## **7\. Security and Encryption Disclaimer**
...
* **Billing:** All financial transactions are processed securely through Google Play Billing. We do not collect, process, or store payment information.  
* **Cancellation:** You may cancel your subscription at any time through the Google Play Store. Cancellation takes effect at the end of the current billing period. No partial refunds are issued for unused portions of a billing period, except where required by applicable law.  
* **Refunds:** Because all transactions are handled by Google Play, refund requests must be routed through the Google Play Store’s standard mechanisms. The Developer does not issue direct refunds.

## **9\. Right to Terminate, Modify Service, and Support Obligations**
...
* **App Store Acknowledgement:** You acknowledge that this Agreement is between you and the Developer only, and not with Google LLC. Google is not responsible for the Application, its content, or its maintenance and support.  
* **Force Majeure:** The Developer shall not be liable for any failure or delay resulting from causes beyond reasonable control, including but not limited to acts of God, natural disasters, server outages due to infrastructure providers, or internet-wide disruptions.  
* **Assignment:** The Developer may assign or transfer these Terms without restriction. You may not assign your rights under these Terms without prior written consent.  
...
* **Entire Agreement:** These Terms constitute the entire agreement between you and the Developer regarding the Application and supersede all prior agreements or understandings.
...
If you have any questions about these Terms, please contact us at: [remotecam.app@gmail.com](mailto:remotecam.app@gmail.com)  
